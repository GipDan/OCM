#!/usr/bin/env python3
"""Train/evaluate real benchmark groups with explicit train/test splits."""
...
from ocm.database import get_connection, init_db  # noqa: E402
from ocm.features import build_training_matrix, optional_derived_features, params_to_feature_row  # noqa: E402
...
def main() -> int:
    ...
    if stored_models:
        ...
        for model in stored_models:
            print(
                f"- {model['op_name']} | ok={model['ok']} | message={model['message']}"
            )
    return 0
